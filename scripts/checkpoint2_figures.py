...
GROUPS = ["dry_heat","fat_heat","moist_heat","combine","prep","apply","passive","liquid"]
GROUP_COLORS = {
    "dry_heat":  "#e74c3c",
    "fat_heat":  "#e67e22",
    "moist_heat":"#3498db",
...
TEMPLATES = {
    "bake":     "Bake {ings} in the oven.",
    "grill":    "Grill {ings} over high heat.",
    "saute":    "Saute {ings} in a pan.",
    "boil":     "Boil {ings} in water.",
    "simmer":   "Simmer {ings}.",
    "steam":    "Steam {ings}.",
    "mix":      "Mix {ings} together.",
    "whisk":    "Whisk {ings}.",
    "blend":    "Blend {ings} until smooth.",
    "knead":    "Knead {ings} into dough.",
    "chop":     "Chop {ings}.",
    "marinate": "Marinate {ings}.",
    "chill":    "Refrigerate {ings} until cold.",
    "season":   "Season {ings}.",
    "reduce":   "Reduce {ings} in a saucepan.",
}
